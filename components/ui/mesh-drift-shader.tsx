...
export function ShaderBackground({ className }: { className?: string }) {
  ...
  useEffect(() => {
    ...
    // requestRender/render son arrow consts, no `function`: con declaraciones `function` (hoisted)
    // TypeScript descarta el estrechamiento de `canvas` y `gl` hecho por los guards de arriba y los
    // vuelve a considerar `| null`, lo que rompe el typecheck del repo. Única desviación respecto al
    // componente original del generador; si se actualiza, hay que reaplicarla.
    const requestRender = () => {
