...
- Acción de datos ejecutada y verificada en producción para WDC: Claudia Martínez quedó asignada
  como closer solo donde estaba vacío — 559/559 agendas y 27/27 ventas. `contacts` no tiene columna
  owner/closer; los leads quedan vinculados a Claudia mediante sus agendas, sin inventar esquema.
