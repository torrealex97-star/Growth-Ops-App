...
**Estado (26-sep): entregado en PR #233 con CI verde (run del SHA b6f85d2, success) y quality PASS en local; quien fusione debe re-verificar `npm run quality` en `main` tras el merge.** No se ejecutaron migraciones ni se consultó/escribió producción.
