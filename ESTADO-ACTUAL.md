# ESTADO ACTUAL — IA WINNERS OS
> Documento vivo. Al retomar la conversación, **lee esto primero** para continuar desde donde lo dejamos.
> Última actualización: **2026-07-02**

## Qué es
App de gestión comercial (Next.js 14 + Supabase + Vercel) para la academia **IA WINNERS**.
- **Producción:** https://iawinners-app.vercel.app · Deploy: `vercel --prod --yes` (cuenta Vercel `creatuagentes-projects`).
...
- **The Closer Club:** todas estas mejoras portadas a https://app.thecloserclub.es (branding propio, sin precios).
...
Worker Railway · 2º webhook GHL real · rotar claves · matices Sequra/reserva · automatizaciones A3 · limpiar contactos de prueba · definir planes/socios propios de Closer Club.
