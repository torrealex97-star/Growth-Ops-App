...
export const DEPARTMENT_PREFIXES: Record<Department, string[]> = {
  ...
  marketing: ['/evergreen/campaigns', '/evergreen/attribution', '/evergreen/content', '/evergreen/content/reels', '/evergreen/instagram', '/evergreen/vsl', '/evergreen/carruseles'],
...
export const ROLE_ALLOWED_PREFIXES: Partial<Record<AppRole, string[]>> = {
  ...
  marketing:   ['/evergreen/campaigns', '/evergreen/attribution', '/evergreen/content', '/evergreen/content/reels', '/evergreen/instagram', '/evergreen/vsl', '/evergreen/carruseles'],
  adscripcion: ['/evergreen/attribution', '/evergreen/campaigns'],
