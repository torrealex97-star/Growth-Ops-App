// Los 6 CTAs / lead magnets del funnel de IA WINNERS. Se usan para (a) el selector
...
export const CTAS: Cta[] = [
  ...
  {
    code: 'VIDEO', label: 'VIDEO — Empezar tu Agencia IA (sistema IA WINNERS)', funnel: 'bottom', avatar: 'agencia',
    description: 'Vídeo que muestra cómo empezar tu Agencia de IA con el sistema IA WINNERS, con el que hemos escalado a +50k/mes y formado a cientos de personas.',
...
export const DEFAULT_BUSINESS_CONTEXT = `NEGOCIO: IA WINNERS — enseñamos a montar y escalar una Agencia de IA (vender servicios de IA/automatización a empresas) y a implementar IA en negocios.
