...
export const NAV_SECTIONS: NavSection[] = [
  {
    dept: null,
    items: [
      { label: 'Dashboard', href: '/dashboard', icon: LayoutDashboard, roles: [...LEAD, 'setter', 'closer', 'affiliate'] },
      { label: 'Métricas', href: '/unit-economics', icon: BarChart3, roles: LEAD },
      { label: 'Tareas', href: '/tasks', icon: ListChecks, roles: [...LEAD, 'setter', 'closer', 'triager', 'cold_caller'] },
    ],
  },
  {
    dept: 'ventas',
