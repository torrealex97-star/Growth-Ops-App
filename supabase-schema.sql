-- ============================================================
-- THE CLOSER CLUB — EVERGREEN SCHEMA
-- Ejecuta este script completo en el SQL Editor de Supabase
-- ============================================================

-- ============================================================
-- 0. CLEANUP (por si hay restos de ejecuciones anteriores)
-- ============================================================
DROP TABLE IF EXISTS public.audit_logs CASCADE;
DROP TABLE IF EXISTS public.saved_dashboard_views CASCADE;
DROP TABLE IF EXISTS public.targets CASCADE;
DROP TABLE IF EXISTS public.kpi_daily_reports CASCADE;
DROP TABLE IF EXISTS public.kpi_form_templates CASCADE;
DROP TABLE IF EXISTS public.commissions CASCADE;
DROP TABLE IF EXISTS public.commission_rules CASCADE;
DROP TABLE IF EXISTS public.refunds CASCADE;
DROP TABLE IF EXISTS public.collections CASCADE;
DROP TABLE IF EXISTS public.sale_expected_installments CASCADE;
DROP TABLE IF EXISTS public.sales CASCADE;
DROP TABLE IF EXISTS public.payment_plans CASCADE;
DROP TABLE IF EXISTS public.products CASCADE;
DROP TABLE IF EXISTS public.appointments CASCADE;
DROP TABLE IF EXISTS public.contact_attributions CASCADE;
DROP TABLE IF EXISTS public.contacts CASCADE;
DROP TABLE IF EXISTS public.users CASCADE;
DROP TABLE IF EXISTS public.roles CASCADE;

DROP FUNCTION IF EXISTS public.get_my_role() CASCADE;
DROP FUNCTION IF EXISTS public.is_admin_or_director() CASCADE;
...
RETURNS BOOLEAN AS $$
  SELECT get_my_role() IN ('admin', 'director');
$$ LANGUAGE sql STABLE SECURITY DEFINER;
...
-- ============================================================
-- 22. ADMIN USER
-- Reemplaza el UUID con el de tu usuario en Supabase Auth
...
DECLARE
  ...
  v_auth_uid UUID;
BEGIN
  SELECT id INTO v_role_id FROM public.roles WHERE key = 'admin' LIMIT 1;

  -- Cambia este UUID si es necesario (debe coincidir con tu auth.users.id)
  v_auth_uid := '2c030ea2-5926-4f27-9685-ae9d27ff94ba';

  INSERT INTO public.users (id, full_name, email, role_id, is_active)
  VALUES (v_auth_uid, 'Adrián Martínez', 'contacts.adrianmartinez@gmail.com', v_role_id, TRUE)
