...
-- La firma de la EMPRESA (la del tenant) es fija y se estampa automáticamente;
...
SELECT
  'Contrato de alumno — Academia Demo',
  'alumno',
  NULL,
...
$tpl$CONTRATO DE FORMACIÓN — ACADEMIA DEMO
...
-- ============================================================
-- VSL tracking ([tenant]) — vturb-style, in-house
-- ============================================================
