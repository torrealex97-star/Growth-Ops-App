-- Elimina la funcionalidad de "socios / reparto de beneficios" (Adrián Martínez, Alex,
-- Jesús Peña — ver settings/partners, pnl y finanzas/analitica/resumen). Clasificación:
