  ...
  return [
    {
      ...
      slides: [
        cover({ url: P["adri-laptop-down"], kicker: "Agentes IA", title: "Tu mejor comercial no duerme. Ni cobra.", pos: "center 22%" }),
        content({ kicker: "El problema", heading: "Cientos de DMs sin contestar", body: "Los leads se enfrían en 20 minutos y tú no llegas a todos. Cada mensaje frío es una llamada perdida." }),
        content({ kicker: "La solución", heading: "Setting AI", body: "Responde tus DMs de Instagram como si fueras tú. En tu tono. Las 24 horas. Nunca suena a bot." }),
        content({ kicker: "Qué hace", heading: "Cualifica y agenda solo", body: "Detecta si el lead tiene tiempo y dinero, y te deja la llamada agendada en el calendario." }),
        cta({ url: P["adri-laptop-front"], title: "¿Lo quieres en tu cuenta?", ctaText: "Escribe «AGENTE»", pos: "center 18%" }),
      ],
    },
    {
      ...
      slides: [
        cover({ url: P["adri-laptop-side"], kicker: "Herramientas", title: "5 herramientas de IA que hacen el trabajo de un equipo", pos: "center 20%" }),
        content({ index: "1", heading: "Carruseles con IA", body: "Le das un tema y te diseña el carrusel con tu marca aplicada. Sí, como este." }),
        content({ index: "2", heading: "Reels del día", body: "Mina reels virales de tu nicho y te devuelve el guión adaptado, con hook y CTA." }),
        content({ index: "3", heading: "Facturas + Llamadas", body: "Foto → datos extraídos. Y transcribe tus ventas puntuándolas /10 para cerrar mejor." }),
        content({ index: "4", heading: "Setting AI", body: "Responde tus DMs y te agenda las llamadas solo, 24/7." }),
        cta({ url: P["adri-laptop-front"], title: "Monta tu propia suite de IA", ctaText: "Comenta «IA»", pos: "center 18%" }),
      ],
    },
    {
      ...
      slides: [
        cover({ url: P["adri-teach-2"], kicker: "Estrategia", title: "Deja de vender por DM. Empieza a cualificar.", pos: "center 15%" }),
        content({ kicker: "El error", heading: "Soltar el precio ya", body: "Dar el precio en el primer mensaje solo espanta leads. Primero se genera contexto." }),
        content({ kicker: "El marco", heading: "D · M · D", body: "Dolor → Miedo → Deseo. Ese es el orden. Con 1 dolor + 1 deseo + 1 freno claros, ya puedes ofrecer la llamada." }),
        content({ kicker: "La táctica", heading: "Valida antes de opinar", body: "Reconoce → Valida → Pregunta. La gente compra a quien la entiende, no a quien la interroga." }),
        content({ kicker: "La regla", heading: "Máx. 1 pregunta cada 3 mensajes", body: "Un DM no es un interrogatorio. Nunca dos «?» seguidos." }),
        cta({ url: P["adri-teach-1"], title: "¿Quieres el guion completo?", ctaText: "Comenta «DMD»", pos: "center 12%" }),
      ],
    },
    {
      ...
      slides: [
        cover({ url: P["adri-class"], kicker: "Servicios", title: "El negocio con menos barreras de 2026", pos: "center 20%" }),
        content({ kicker: "Reencuadre", heading: "No era tu culpa", body: "Probaste dropshipping, trading, FBA… y nada funcionó. No eras tú: era el vehículo." }),
        content({ kicker: "La oportunidad", heading: "Los negocios quieren IA", body: "Pero no saben ni por dónde empezar. Ahí entras tú: les montas la solución y cobras por ello." }),
        content({ kicker: "La ventaja", heading: "Sin stock. Sin equipo.", body: "Sin oficina. Solo tú, un ordenador y un sistema que funciona." }),
        content({ heading: "Haces el trabajo de dueño de agencia… cobrando el sueldo de otro." }),
        cta({ url: P["adri-teach-1"], title: "Te enseño el modelo en una llamada", ctaText: "Comenta «AGENCIA»", pos: "center 12%" }),
      ],
    },
    {
      ...
      slides: [
        cover({ url: P["adri-laptop-front"], kicker: "Mi historia", title: "Me quedaban 1.600€. Y una deuda enorme.", pos: "center 16%" }),
        content({ heading: "Toqué fondo", body: "9 años y medio de discotecas. Monté la mía. Me arruiné. Ansiedad, depresión, deuda." }),
        content({ heading: "El giro", body: "Con lo último que me quedaba me compré un ordenador y monté una agencia desde el salón de mi casa." }),
        content({ big: "1.500€", heading: "Primer cliente en menos de 7 días" }),
        content({ heading: "Hoy", body: "Vivo en Andorra, trabajo desde Bali y tengo una comunidad de cientos de Winners." }),
        cta({ url: P["adri-class"], title: "El sistema es Master IA Expert", ctaText: "Comenta «WINNER»", pos: "center 18%" }),
      ],
    },
    // ---- 3 VIRALES ----
    {
      ...
      slides: [
        cover({ url: P["adri-laptop-down"], kicker: "Viral", title: "5 cosas que la IA hace por ti mientras duermes", pos: "center 22%" }),
        content({ index: "1", heading: "Responde tus DMs", body: "Y te agenda clientes en el calendario sin que muevas un dedo." }),
        content({ index: "2", heading: "Te escribe los reels", body: "Analiza lo que se está haciendo viral en tu nicho y te da el guión." }),
        content({ index: "3", heading: "Lleva tu contabilidad", body: "Le haces una foto a la factura y la registra por ti." }),
        content({ index: "4", heading: "Diseña tus carruseles", body: "Con tu marca. Como el que estás viendo ahora mismo." }),
        cta({ url: P["adri-laptop-front"], title: "Y esto es solo el principio", ctaText: "Sígueme para más", note: "Guarda esto para no perderlo", pos: "center 18%" }),
      ],
    },
    {
      ...
      slides: [
        cover({ url: P["adri-teach-1"], kicker: "Viral", title: "La IA no te va a quitar el trabajo.", pos: "center 12%" }),
        content({ heading: "Te lo va a quitar quien sepa usarla." }),
        content({ kicker: "Piénsalo", heading: "Ya ha pasado antes", body: "En 2005 no saber usar internet te dejaba fuera. En 2026 es la IA. La historia se repite." }),
        content({ kicker: "La buena noticia", heading: "Aún estás a tiempo", body: "De estar en el lado correcto de la línea. Pero la ventana se cierra rápido." }),
        cta({ url: P["adri-laptop-front"], title: "Empieza hoy, no mañana", ctaText: "Comenta «IA»", pos: "center 18%" }),
      ],
    },
    {
      ...
      slides: [
        cover({ url: P["adri-laptop-side"], kicker: "Caso real", title: "Cobré 1.500€ por algo que monté en una tarde", pos: "center 20%" }),
        content({ kicker: "El problema", heading: "El negocio perdía clientes", body: "Le escribían por Instagram y nadie respondía a tiempo. Leads a la basura cada día." }),
        content({ kicker: "La solución", heading: "Un agente de IA", body: "Le monté un sistema que responde y agenda solo, 24/7, con su tono de marca." }),
        content({ kicker: "El resultado", heading: "Él ahorra horas. Yo cobré.", body: "Por un sistema que sigue funcionando aunque yo esté durmiendo." }),
        cta({ url: P["adri-class"], title: "Esto es una Agencia de IA", ctaText: "Comenta «AGENCIA»", pos: "center 18%" }),
      ],
    },
  ]
}
