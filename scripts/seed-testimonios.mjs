...
const photo = (slug) => sb.storage.from(BUCKET).getPublicUrl(`reference/casos-exito/${slug}.png`).data.publicUrl
...
const T = [
  {
    ...
    name: 'Xavi',
    kind: 'alumno',
    avatar: 'Emprendedor / trabajador quemado',
  ...
  },
  {
    ...
    punto_b:
      'Agencia de IA + marketing a pleno rendimiento, con dos clientes cerrados (uno simple y uno integral con CRM y funnels).',
  ...
  },
  {
    ...
    name: 'Maxi',
    kind: 'alumno',
    avatar: 'Empresario / trabajador quemado',
    sector: 'Inmobiliaria',
    hook: 'De llamadas frías a 23.000€ en 30 días, sin pisar la calle.',
    punto_a:
      'Sector inmobiliario muy físico: llamadas frías y tú a tú. Cansado y desmotivado porque el negocio no crecía.',
    punto_b:
      'Inmobiliaria 100% online apalancada en IA que capta y filtra propietarios interesados en vender. Él solo cierra.',
  ...
  },
  {
    ...
    name: 'Claudia',
    kind: 'alumno',
    avatar: 'Perfil comercial / marketing digital',
  ...
  },
  {
    ...
    name: 'José Luis',
    kind: 'alumno',
    avatar: 'Empresario / consultor con experiencia',
    sector: 'Eventos y conciertos (Ecuador)',
    hook: '16 años corporativos. Hoy hace IA para conciertos internacionales.',
    punto_a:
      '16 años de carrera corporativa (gerente de producto y gerente país). Emprendió como consultor pero sin diferenciación real.',
    punto_b:
      'Diseña y ejecuta estrategias de marketing con IA para eventos masivos y giras internacionales. Libertad total de tiempo para su familia.',
    vehiculo:
      'Formación de automatizaciones primero y escalado al programa completo tras validar resultados. 15 meses en el ecosistema.',
  ...
  },
  {
    ...
    name: 'Adexe',
    kind: 'alumno',
    avatar: 'Técnico autodidacta / empresario',
    ...
    punto_b:
      'Montó su agencia, aplicó lo aprendido a su propio negocio de Airbnb y captó clientes por red de contactos sin marca personal.',
  ...
  },
  {
    ...
    punto_a:
      'Agencia de marketing y escuela de publicidad con 5 años, con mucho trabajo manual y miedo a quedarse atrás.',
    punto_b:
      'Con una sola automatización liberó 2 horas diarias a un empleado clave. Aplicando IA a su captación de Meta Ads.',
  ...
  },
  {
    ...
    name: 'Mark',
    kind: 'alumno',
    avatar: 'Perfil comercial / consultor digital',
    sector: 'Negocios digitales e infoproductos',
    hook: '3 días dentro. Primera venta cerrada. Inversión recuperada.',
    punto_a:
      'Ya hacía embudos e infoproductos para clientes, pero sin la capa de IA y con clientes que no podían contratar más personal.',
    punto_b: 'Primera venta a los 3 días y más reuniones agendadas, incluida una para desarrollo de una aplicación.',
    vehiculo:
      'Fue directo al módulo de servicios paquetizados y precios, apoyándose en el equipo técnico de la comunidad.',
  ...
  },
  {
    ...
    name: 'Miguel',
    kind: 'alumno',
    avatar: 'Trabajador quemado (sector financiero)',
    sector: 'Inmobiliaria',
    hook: '11 clientes recurrentes. De empleado de fintech a dueño de agencia de IA.',
    punto_a:
      'Empleado en una fintech con un trabajo metódico que le aburría, sin saber nada de tecnología y saltando de vídeo en vídeo sin resultados.',
    punto_b:
      'Vive de su agencia de IA ennichada en inmobiliaria, con 11 clientes recurrentes y facturación estable. Superó su miedo a vender.',
    vehiculo:
      'Master Intensivo y luego el programa completo, siguiendo la metodología paso a paso sin saltarse ninguno. Empaquetó 3 servicios para inmobiliaria.',
  ...
  },
  {
    ...
    name: 'María',
    kind: 'alumno',
    avatar: 'Trabajador quemado (perfil no técnico)',
    sector: 'Docencia → agencia de IA',
    hook: 'No sabía ni usar ChatGPT. 4 meses después: N8N, Make y Claude Code.',
    punto_a:
      'Maestra Montessori de 29 años, partía de cero absoluto: no usaba ni ChatGPT. Su miedo no era la academia, era «¿seré yo capaz?».',
    punto_b:
      'Entiende la lógica de automatizar y ha avanzado en Make, Go High Level, N8N y Claude Code. Roto el mito de que hace falta programar.',
    vehiculo:
      'Master Intensivo como puerta de entrada (completado en 6 días) y escalado al programa completo. La guía paso a paso y la comunidad.',
  ...
  },
  {
    ...
    name: 'Alberto',
    kind: 'alumno',
    avatar: 'Empresario que automatiza su negocio',
    sector: 'Empresa propia (administración y energía)',
    hook: '5-6 horas al día metiendo datos. Hoy: 1 hora, y solo en lo que le gusta.',
    punto_a:
      'Empresario con programación obsoleta de hace 30 años, metiendo facturas y 24 datos diarios del precio de la luz a mano, con errores frecuentes.',
    punto_b:
      'Automatizó toda la parte administrativa: facturas, cobros bancarios, recibos, seguimiento del precio de la luz y un agente que gestiona su WhatsApp. Trabaja ~1 hora al día.',
    vehiculo:
      'Aprendió N8N sin programar dentro de la academia, empezando por una automatización sencilla y escalando a un ecosistema de agentes.',
  ...
  },
  {
    ...
    name: 'Blanca',
    kind: 'alumno',
    avatar: 'Agencia de marketing / perfil comercial',
    ...
    punto_b:
      'Primer chatbot creado, automatizaciones de contenido y de agendamiento, y claridad sobre cómo paquetizar y poner precio.',
  ...
  },
  {
    ...
    name: 'Isabel Soler',
    kind: 'alumno',
    avatar: 'Trabajador quemado (funcionaria)',
    sector: 'Gestión de inmuebles / marketing',
    hook: '25 años de funcionaria. Un año de agencia de IA. Mismo sueldo, cero techo.',
    punto_a:
      '25 años como funcionaria con 2.500€ y 18 años más de la misma proyección. Vendía funnels como freelance pero con «caos y desorden».',
    punto_b:
      'Transicionó su agencia hacia servicios de IA. Igualó y superó su sueldo de funcionaria en un año, con libertad total de horario.',
    vehiculo:
      'Sobre todo la parte comercial: cómo paquetizar servicios de IA y vender una realidad, más la comunidad para mantenerse actualizada.',
    cifra:
      '2.500€/mes recurrentes igualados en el primer año · caso cliente: 50-60 emails/día automatizados en 107 apartamentos',
    has_revenue: true,
    sort_order: 130,
  },
  {
    ...
    name: 'Jesús',
    kind: 'alumno',
    avatar: 'Trabajador quemado (hostelería)',
    sector: 'Fisioterapia, dental y extraescolares',
    hook: 'De poner cachimbas en discotecas a 6 clientes de IA.',
    punto_a:
      'Recorrido 100% de hostelería y temporadas. Nivel de partida en IA de 2-3 sobre 10 y sin experiencia construyendo automatizaciones.',
    punto_b:
      'Agencia montada con un equipo de 4 (2 desarrolladores y 2 closers), con 6 clientes captados y 4 casi cerrados en 5 meses.',
    vehiculo:
      'Entró por recomendación boca a boca. Destaca el GPT calculador de precios y las clases en directo para dudas técnicas concretas.',
  ...
  },
  {
    ...
    name: 'Carolina',
    kind: 'alumno',
    avatar: 'Empleada / madre → emprendedora',
    sector: 'Salud y clínicas',
    hook: 'Nunca fue emprendedora. Un mes después: 5 clientes y casi 10.000€.',
    punto_a:
      'Toda su carrera como empleada haciendo marketing para clínicas. Crecía a costa de no poder recoger a sus hijos del colegio.',
    punto_b:
      'Agencia con su marido y su antigua jefa especializada en salud, con recepcionista de IA y CRM sobre Go High Level. 5 clientes en un mes.',
    vehiculo:
      'Master Intensivo en su baja de maternidad y escalado al IA Expert. Destaca el módulo de paquetización y pricing y el de Go High Level.',
  ...
  },
  {
    ...
    name: 'Stefano',
    kind: 'alumno',
    avatar: 'Técnico / desarrollador',
    sector: 'Automatizaciones (nómada)',
    hook: 'Un año sin encontrar trabajo de programador. Hoy vive y trabaja desde su autocaravana.',
    punto_a:
      'Desarrollador de apps móviles freelance, casi un año sin encontrar trabajo estable y pensando siempre en euros por hora.',
    punto_b:
      'Agencia de IA propia, automatizaciones avanzadas con N8N y Claude Code, y vida a tiempo completo en la autocaravana que construyó él mismo.',
    vehiculo:
      'Master Intensivo y IA Expert usados «just-in-time»: busca la lección concreta justo antes de necesitarla. El módulo de venta por valor.',
  ...
  },
  {
    ...
    name: 'María Paz',
    kind: 'alumno',
    avatar: 'Gerente de IT → emprendedora',
    ...
    punto_a:
      'Gerente de IT con años de experiencia, harta de ser empleada y con valores desalineados con la compañía. Su miedo real era estar sola.',
    punto_b:
      'Desarrolla sus propias soluciones, colabora con más de 8 comerciales y ya entra en reuniones con clientes a presentar demos. Todavía sin cerrar la primera venta.',
    vehiculo:
      'Eligió el perfil técnico y se apalanca en los comerciales de la comunidad. Destaca el networking y las clases en directo.',
  ...
  },
  {
    ...
    name: 'Bartomeu',
    kind: 'cliente',
    avatar: 'Empresario (cliente de implementación)',
    sector: 'Asesoría fiscal',
    hook: 'Le costaba 2.500€/mes agendar citas. Ahora paga 300€.',
    punto_a:
      'Asesor fiscal autónomo gestionando a mano sus recordatorios y agenda, con el coste alternativo de una secretaria (~2.500€/mes).',
    punto_b:
      'CRM automatizado que agenda, cobra y gestiona citas y recordatorios (email un día antes, una hora antes y WhatsApp 10 minutos antes).',
