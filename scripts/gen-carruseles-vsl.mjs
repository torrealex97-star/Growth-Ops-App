...
function content({ index, kicker, heading, body, big }) {
  const bigBlock = big ? `<div style="font-family:${DISPLAY};font-weight:800;font-size:140px;line-height:1;${CHROME}margin-bottom:24px;">${big}</div>` : ""
  const idxBlock = index ? `<div style="font-family:${DISPLAY};font-weight:800;font-size:40px;color:${C.accent};width:88px;height:88px;border-radius:20px;background:rgba(30,158,255,.12);border:1px solid rgba(30,158,255,.35);display:flex;align-items:center;justify-content:center;box-shadow:0 0 30px rgba(30,158,255,.25);margin-bottom:40px;">${index}</div>` : ""
  const kickerBlock = kicker ? `<div style="font-family:${DISPLAY};font-weight:700;font-size:26px;letter-spacing:.16em;text-transform:uppercase;color:${C.accent2};margin-bottom:26px;">${kicker}</div>` : ""
  return root(`
  ...
  return [
    {
      ...
      slides: [
        cover({ url: P["adri-laptop-front"], kicker: "El cambio de era", title: "En 2 años habrá 3 tipos de personas", pos: "center 16%" }),
        content({ index: "1", heading: "El que usa Agentes IA", body: "El empresario que los incorpora en su negocio… y crece el doble." }),
        content({ index: "2", heading: "El que sabe implementarla", body: "El profesional que aprende a trabajar con IA y se la vende a esos empresarios." }),
        content({ index: "3", heading: "El que compite contra ella", body: "El que la ignora… y acaba desapareciendo. Su negocio o su empleo." }),
        content({ kicker: "La verdad", heading: "La ventana se está cerrando", body: "Todavía estás a tiempo de subirte a la ola. Pero más rápido de lo que crees." }),
    ...
    },
    {
      ...
      slides: [
        cover({ url: P["adri-event-numbers"], kicker: "El Peaje de la IA", title: "Lo que le pasó a la web… le pasará a la IA", pos: "center 22%" }),
        content({ heading: "La IA dejará de ser una ventaja", body: "Y pasará a ser una necesidad. Como tener página web o correo electrónico." }),
        content({ heading: "Millones de empresas la necesitarán", body: "Pero la inmensa mayoría no sabe ni por dónde empezar." }),
        content({ kicker: "Aquí está el negocio", heading: "No en crear IA. En implementarla.", body: "Igual que hoy buscan abogados o agencias de marketing… buscarán a quien sepa aplicar IA." }),
    ...
    },
    {
      ...
      slides: [
        cover({ url: P["adri-cafe-work"], kicker: "La gran mentira", title: "No necesitas saber programar", pos: "70% 28%" }),
        content({ heading: "Las empresas no buscan ingenieros", body: "Buscan ahorrar tiempo, captar clientes, responder rápido y reducir costes." }),
        content({ heading: "Les da igual el código", body: "Diez líneas de programación o una herramienta no-code. Solo quieren que funcione." }),
        content({ kicker: "Tu trabajo", heading: "Resolver problemas, no inventar tecnología", body: "Conviértete en la persona que sabe implementar IA. Esa es la habilidad mejor pagada." }),
    ...
    },
    {
      ...
      slides: [
        cover({ url: P["adri-cafe-think"], kicker: "El modelo", title: "Qué hace de verdad una Agencia de IA", pos: "70% 28%" }),
        list({
        ...
        content({ heading: "No creas tecnología", body: "Utilizas tecnología que YA existe para resolver problemas reales. Eso es todo." }),
    ...
    },
    {
      ...
      slides: [
        cover({ url: P["adri-event-point"], kicker: "La clave", title: "No vendes IA. Vendes resultados.", pos: "center 22%" }),
        content({ kicker: "Ejemplo real", heading: "Una inmobiliaria", body: "Cada contacto perdido son miles de euros. La IA responde, califica, agenda y hace seguimiento." }),
        content({ heading: "No cuesta dinero. Genera dinero.", body: "Porque evita perder clientes. Por eso el dueño está dispuesto a pagar por ello." }),
        content({ kicker: "Recuérdalo", heading: "Las empresas pagan por soluciones", body: "No por tecnología. Y eso hace este modelo mucho más sencillo de lo que imaginas." }),
    ...
    },
    {
      ...
      slides: [
        cover({ url: P["adri-event-smile"], kicker: "El sistema", title: "Las 4 claves para vivir de la IA", pos: "center 20%" }),
        content({ index: "1", heading: "Encontrar la oportunidad", body: "Detectar un problema que le está costando mucho dinero a un negocio." }),
        content({ index: "2", heading: "Paquetizar la solución", body: "Resolverlo, empaquetarlo y ponerle precio: entre 1.500€ y 3.500€." }),
        content({ index: "3", heading: "Conseguir clientes", body: "Sistemas automáticos con agentes de IA que atraen clientes interesados." }),
        content({ index: "4", heading: "Escalar a agencia", body: "Equipo, sistemas y estrategia para crecer sin meter más horas ni más dinero." }),
    ...
    },
    {
      ...
      slides: [
        cover({ url: P["adri-laptop-down"], kicker: "Piénsalo bien", title: "La oportunidad no es la herramienta", pos: "center 20%" }),
        content({ heading: "Las herramientas caducan", body: "Hace 2 años casi nadie hablaba de ChatGPT. En 5 años habrá otras distintas." }),
        content({ kicker: "Lo que permanece", heading: "Saber implementarla", body: "Ser el profesional que ayuda a las empresas a adoptar la tecnología. Eso sí tiene valor." }),
    ...
    },
    {
      ...
      slides: [
        cover({ url: P["adri-mentoring"], kicker: "Por qué IA WINNERS", title: "No enseñamos teoría. Enseñamos lo que hacemos.", pos: "center 32%" }),
        content({ heading: "Primero construimos la agencia", body: "Implementando IA en empresas reales. Después documentamos el sistema. Y luego lo enseñamos." }),
        list({
        ...
        content({ kicker: "Lo que medimos", heading: "Resultados, no vídeos vistos", body: "Ver clases no cambia una vida. Construir un negocio con clientes e ingresos, sí." }),
    ...
    },
    {
      ...
      slides: [
        cover({ url: P["adri-laptop-front"], kicker: "Mi historia", title: "El día que me quedaban 1.699€", pos: "center 16%" }),
        content({ heading: "Casi 10 años en el mundo de la noche", body: "Camarero, promotor, director de discotecas. Desde fuera parecía increíble. Por dentro, ni libertad ni propósito." }),
        content({ heading: "Se juntó todo", body: "Mi pareja me dejó. Entré en depresión. Me arruiné. Y perdí a mi mejor amigo, Óscar." }),
        content({ heading: "Dos opciones", body: "Aceptar que esa iba a ser mi vida… o empezar desde cero. Elegí empezar." }),
        content({ kicker: "Entonces llegó ChatGPT", heading: "Y vi una necesidad gigante", body: "Donde otros veían una herramienta de preguntas, yo vi que toda empresa necesitaría IA." }),
    ...
    },
    {
      ...
      slides: [
        cover({ url: P["adri-teach-1"], kicker: "Sé honesto contigo", title: "Esto no es para todo el mundo", pos: "center 12%" }),
        content({ kicker: "No es para ti si…", heading: "Buscas atajos", body: "Si esperas que la IA lo haga por ti tocando 2 botones, o no quieres aprender una habilidad nueva." }),
        content({ kicker: "Sí es para ti si…", heading: "Piensas como empresario", body: "Estás dispuesto a comprometerte y a construir un negocio serio, paso a paso." }),
