...
export default function SeguimientoPage() {
  ...
  const fetchData = async () => {
    ...
    // Mismo criterio de scoping que /evergreen/appointments: liderazgo y quien tiene visibilidad
  ...
  const handleFollowupStageChange = async (
    ...
    try {
      const res = await fetch('/api/evergreen/appointments/followup-stage', {
        method: 'PATCH',
