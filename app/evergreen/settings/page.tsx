...
import { Package, Percent, UserCog, FileText, Building2, FileSignature, ChevronRight, TrendingUp } from 'lucide-react'
...
const SETTINGS_CARDS = [
  {
    ...
    icon: Building2,
    href: '/evergreen/settings/empresa',
  ...
  },
  {
    ...
    icon: FileSignature,
    href: '/evergreen/contratos/equipo',
    color: 'text-sky-400',
    bg: 'bg-sky-500/10',
  },
  {
    ...
    icon: Package,
    href: '/evergreen/settings/products',
  ...
  },
  {
    ...
    icon: Percent,
    href: '/evergreen/settings/commission-rules',
  ...
  },
  {
    ...
    icon: TrendingUp,
    href: '/evergreen/settings/afiliados',
    color: 'text-brand-400',
    bg: 'bg-brand-500/10',
  },
]
