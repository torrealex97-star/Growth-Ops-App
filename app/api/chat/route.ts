...
export async function POST(req: NextRequest) {
  try {
    ...
    const systemPrompt = `Eres un analista experto en marketing y ventas para "[tenant]", un programa de formación en ventas/closing lanzado en mayo 2026 por una emprendedora española.
