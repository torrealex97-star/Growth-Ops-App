...
// Uso: POST /api/evergreen/admin/setup  con cabecera  x-cron-secret: <CRON_SECRET>
  ...
  try {
    ...
    await sql.unsafe(`
      ...
      CREATE TABLE IF NOT EXISTS public.company_profile (
        id INT PRIMARY KEY DEFAULT 1, name TEXT NOT NULL DEFAULT 'IA WINNERS', legal_name TEXT, cif TEXT,
      ...
      INSERT INTO public.company_profile (id, name, legal_name, cif) VALUES (1,'IA WINNERS','IA WINNERS','B-00000000') ON CONFLICT (id) DO NOTHING;
