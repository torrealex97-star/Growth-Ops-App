      ...
      <div className="flex items-start justify-between">
        ...
        {isReservation && (
          <Button
            ...
            onClick={() => router.push(`/${tenant}/sales/new?contact=${sale.contact_id}&reserva=${sale.reservation_amount ?? sale.gross_amount}&product=${sale.product_id}&reservationId=${sale.id}`)}
          >
