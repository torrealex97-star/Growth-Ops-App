...
import { ControlPagosPersonas } from '@/components/finanzas/ControlPagosPersonas'
...
export default function PaymentsPipelinePage() {
  ...
  // VISTA: "persona" (default) responde a cuánto lleva pagada cada persona/suscripción/impagos;
  // "venta" conserva el kanban por venta.
  const [vista, setVista] = useState<'persona' | 'venta'>('persona')
  ...
  return (
    <div className="space-y-6">
      ...
      {/* VISTA: Por persona (default) / Por venta */}
